rem T_LOCK: DDL Trigger to protect objects not managed by PeopleTools on PeopleSoft tables
...
rem 20006-Cannot alter PSRECDEFN because T_LOCK refernces it
...
set echo on feedback on verify on message on lines 100 timi on 
spool t_lock
...
EXCEPTION
 ...
 WHEN e_generate_message THEN /*reraise custom exception*/
  RAISE_APPLICATION_ERROR(l_errno,'T_LOCK: '||l_msg||CHR(10)||l_msg2||CHR(10)||'SQL:'||l_sql_stmt);
END;
/
